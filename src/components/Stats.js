...
const Stats = () => {
    return (
       <div>
          ...
          <img src={hero} className="App-hero80" alt="hero"/><br/>

          <br/>
          <h1>Stats</h1>
          <p className="sponsor">Stats<u><b>before</b></u> any given sunday, if you and your buisness would like sponsor us or (make a small donation)  you will achieve advertiserment rights by way of patch on uniforms and/or 1sqft spot on giant dugout banner/dugout covering both for the whole season.<br/>NOTE! We change uniforms every season so if you always want a spot on either option provided please see sponsor page for more info.</p>
       </div>
